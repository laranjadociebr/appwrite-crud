...
import type { Cliente } from "@/src/types/entities";
import { listClientes, createCliente } from "@/src/services/appwriteCrud";
...
export default function ClientesScreen() {
  ...
  async function handleSave() {
    ...
    try {
      setSaving(true);
      await createCliente(form.nome.trim(), form.telefone.trim());
      closeModal();
      await loadClientes();
    } catch (error) {
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Pressable style={styles.primaryButton} onPress={openModal}>
          <Text style={styles.primaryButtonText}>+ Novo cliente</Text>
        </Pressable>
      </View>

      <Text style={styles.subtitle}>
        Lista didática de clientes vindos da collection `cliente`.
      </Text>
